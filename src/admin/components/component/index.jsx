              ...
              <div className="row">
                  ...
                  <div className="card">
                    ...
                    <div className="card-body">
											<div className="avatar avatar-xxl">
												<img className="avatar-img rounded-circle me-1" alt="User Image" src={avatar02}/>
											</div>
                ...
                <div className="col-md-12">
                  <div className="card">
                    ...
                    <div className="card-body">
											<div className="avatar">
												<img className="avatar-img rounded me-1" alt="User Image" src={avatar02}/>
											</div>
											<div className="avatar">
												<img className="avatar-img rounded-circle me-1" alt="User Image" src={avatar02}/>
											</div>
                  ...
                  <div className="card">
                    ...
                    <div className="card-body">
											<div className="avatar-group">
												<div className="avatar">
													<img className="avatar-img rounded-circle border border-white me-1" alt="User Image" src={avatar02}/>
												</div>
												<div className="avatar">
													<img className="avatar-img rounded-circle border border-white me-1" alt="User Image" src={avatar03}/>
												</div>
												<div className="avatar">
													<img className="avatar-img rounded-circle border border-white me-1" alt="User Image" src={avatar04} />
												</div>
												<div className="avatar">
													<span className="avatar-title rounded-circle border border-white me-1">CF</span>
												</div>
											</div>
										</div>
                  </div>
            ...
            {/* <!-- Buttons --> */}
						<section className="comp-section comp-buttons">
								...
								<div className="card-body">
									...
									<div className="btn-toolbar">
										<div className="btn-group btn-group-lg">
											<button type="button" className="btn btn-primary me-1">Left</button>
											<button type="button" className="btn btn-primary me-1">Middle</button>
											<button type="button" className="btn btn-primary me-1">Right</button>
										</div>
									</div>
									<br/>
									<div className="btn-toolbar">
								...
								<div className="card-body">
									<div className="row row-sm align-items-center">
										...
										<div className="col-6 col-sm-4 col-md-2 col-xl mb-3 mb-xl-0">
											<button type="button" className="btn w-100 btn-outline-primary me-1">Primary</button>
										</div>
										<div className="col-6 col-sm-4 col-md-2 col-xl mb-3 mb-xl-0">
											<button type="button" className="btn w-100 btn-outline-secondary me-1">Secondary</button>
										</div>
										<div className="col-6 col-sm-4 col-md-2 col-xl mb-3 mb-xl-0">
											<button type="button" className="btn w-100 btn-outline-success me-1">Success</button>
										</div>
										<div className="col-6 col-sm-4 col-md-2 col-xl mb-3 mb-xl-0">
											<button type="button" className="btn w-100 btn-outline-warning me-1">Warning</button>
										</div>
										<div className="col-6 col-sm-4 col-md-2 col-xl mb-3 mb-xl-0">
											<button type="button" className="btn w-100 btn-outline-danger me-1">Danger</button>
										</div>
										<div className="col-6 col-sm-4 col-md-2 col-xl mb-3 mb-xl-0">
											<button type="button" className="btn w-100 btn-outline-info me-1">Info</button>
										</div>
										<div className="col-6 col-sm-4 col-md-2 col-xl mb-3 mb-xl-0">
											<button type="button" className="btn w-100 btn-outline-light me-1">Light</button>
										</div>
										<div className="col-6 col-sm-4 col-md-2 col-xl mb-3 mb-xl-0">
											<button type="button" className="btn w-100 btn-outline-dark me-1">Dark</button>
										</div>
									</div>
									<div className="row row-sm align-items-center mt-3">
										<div className="col-12 col-xl mb-3">Active</div>
										<div className="col-6 col-sm-4 col-md-2 col-xl mb-3 mb-xl-0">
											<button type="button" className="btn w-100 btn-outline-primary active me-1">Primary</button>
										</div>
										<div className="col-6 col-sm-4 col-md-2 col-xl mb-3 mb-xl-0">
											<button type="button" className="btn w-100 btn-outline-secondary active me-1">Secondary</button>
										</div>
										<div className="col-6 col-sm-4 col-md-2 col-xl mb-3 mb-xl-0">
											<button type="button" className="btn w-100 btn-outline-success active me-1">Success</button>
										</div>
										<div className="col-6 col-sm-4 col-md-2 col-xl mb-3 mb-xl-0">
											<button type="button" className="btn w-100 btn-outline-warning active me-1">Warning</button>
										</div>
										<div className="col-6 col-sm-4 col-md-2 col-xl mb-3 mb-xl-0">
											<button type="button" className="btn w-100 btn-outline-danger active me-1">Danger</button>
										</div>
										<div className="col-6 col-sm-4 col-md-2 col-xl mb-3 mb-xl-0">
											<button type="button" className="btn w-100 btn-outline-info active me-1">Info</button>
										</div>
										<div className="col-6 col-sm-4 col-md-2 col-xl mb-3 mb-xl-0">
											<button type="button" className="btn w-100 btn-outline-light active me-1">Light</button>
										</div>
										<div className="col-6 col-sm-4 col-md-2 col-xl mb-3 mb-xl-0">
											<button type="button" className="btn w-100 btn-outline-dark active me-1">Dark</button>
										</div>
									</div>
									<div className="row row-sm align-items-center mt-3">
										<div className="col-12 col-xl mb-3">Disabled</div>
										<div className="col-6 col-sm-4 col-md-2 col-xl mb-3 mb-xl-0">
											<button disabled="" type="button" className="btn w-100 btn-outline-primary me-1">Primary</button>
										</div>
										<div className="col-6 col-sm-4 col-md-2 col-xl mb-3 mb-xl-0">
											<button disabled="" type="button" className="btn w-100 btn-outline-secondary me-1">Secondary</button>
										</div>
										<div className="col-6 col-sm-4 col-md-2 col-xl mb-3 mb-xl-0">
											<button disabled="" type="button" className="btn w-100 btn-outline-success me-1">Success</button>
										</div>
										<div className="col-6 col-sm-4 col-md-2 col-xl mb-3 mb-xl-0">
											<button disabled="" type="button" className="btn w-100 btn-outline-warning me-1">Warning</button>
										</div>
										<div className="col-6 col-sm-4 col-md-2 col-xl mb-3 mb-xl-0">
											<button disabled="" type="button" className="btn w-100 btn-outline-danger me-1">Danger</button>
										</div>
										<div className="col-6 col-sm-4 col-md-2 col-xl mb-3 mb-xl-0">
											<button disabled="" type="button" className="btn w-100 btn-outline-info me-1">Info</button>
										</div>
										<div className="col-6 col-sm-4 col-md-2 col-xl mb-3 mb-xl-0">
											<button disabled="" type="button" className="btn w-100 btn-outline-light me-1">Light</button>
										</div>
										<div className="col-6 col-sm-4 col-md-2 col-xl mb-3 mb-xl-0">
											<button disabled="" type="button" className="btn w-100 btn-outline-dark me-1">Dark</button>
										</div>
									</div>
								</div>
							</div>
							...
							<div className="card mb-4">
								...
								<div className="card-body">
									<button type="button" className="btn btn-primary me-1"><span className="spinner-border spinner-border-sm me-2" role="status"></span>Primary</button>
									<button type="button" className="btn btn-secondary me-1"><span className="spinner-border spinner-border-sm me-2" role="status"></span>Secondary</button>
									<button type="button" className="btn btn-success me-1"><span className="spinner-border spinner-border-sm me-2" role="status"></span>Success</button>
									<button type="button" className="btn btn-danger me-1"><span className="spinner-border spinner-border-sm me-2" role="status"></span>Danger</button>
									<button type="button" className="btn btn-warning me-1"><span className="spinner-border spinner-border-sm me-2" role="status"></span>Warning</button>
									<button type="button" className="btn btn-info me-1"><span className="spinner-border spinner-border-sm me-2" role="status"></span>Info</button>
									<button type="button" className="btn btn-dark me-1"><span className="spinner-border spinner-border-sm me-2" role="status"></span>Dark</button>
								</div>
							</div>
							{/* <!-- /Progress Button --> */}
						</section>
