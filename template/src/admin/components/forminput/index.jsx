                        ...
                        <div className="card">
                            ...
                            <form action="#">
                                ...
                                <div className="col-lg-10">
                                    ...
                                    <button
                                        type="button"
                                        className={menu ? 'btn btn-white dropdown-toggle show': 'btn btn-white dropdown-toggle'}
                                    ...
                                    {/* <div className="dropdown-menu " > */}
                                        <Link className="dropdown-item" to="#" onClick={(value)=>toggleMenu()}>
                                        Action
                                        </Link>
                                        <Link className="dropdown-item" to="#" onClick={(value)=>toggleMenu()}>
                                        Another action
                                ...
                                <div className="col-lg-10">
                                    ...
                                    <button
                                        type="button"
                                        className={menu1 ? 'btn btn-white dropdown-toggle show': 'btn btn-white dropdown-toggle'}
                                        data-bs-toggle="dropdown"
                                        onClick={(value)=>toggleMenu1()}
                                    >
                                        Action
                                    </button>
                                    <div className={menu1 ? 'dropdown-menu dropdown-menu-end show': 'dropdown-menu dropdown-menu-end'}>
                                    {/* <div className="dropdown-menu dropdown-menu-end"> */}
                                        <Link className="dropdown-item" to="#" onClick={(value)=>toggleMenu1()}>
                                        Action
                                        </Link>
                                        <Link className="dropdown-item" to="#" onClick={(value)=>toggleMenu1()}>
                                        Another action
